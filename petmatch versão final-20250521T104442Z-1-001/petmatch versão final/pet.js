document.addEventListener("DOMContentLoaded", () => {
  ...
  petForm.addEventListener("submit", (e) => {
    ...
    const especie       = document.getElementById("especiePet").value.trim();
    ...
    if (!nome || !especie || !idade || !localiz
        || !sexo || !castrado || !vacinas || !energia
        || !criancas || !animais || !comportamento || !termos) {
